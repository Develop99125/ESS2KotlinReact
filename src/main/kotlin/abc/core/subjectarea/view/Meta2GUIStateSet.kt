...
@Serializable
class Meta2GUIStateSet : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIStateSet{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIStateSet>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIStateSet.fontSize != 0) this@Meta2GUIStateSet.fontSize.px else DefaultTextSize.px
            }
