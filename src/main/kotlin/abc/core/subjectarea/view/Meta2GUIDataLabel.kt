...
@Serializable
class Meta2GUIDataLabel : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIDataLabel{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIDataLabel>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIDataLabel.fontSize != 0) this@Meta2GUIDataLabel.fontSize.px else DefaultTextSize.px
            }
