...
@Serializable
class Meta2GUIESSSettingString : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIESSSettingString{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIESSSettingString>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIESSSettingString.fontSize != 0) this@Meta2GUIESSSettingString.fontSize.px else DefaultTextSize.px
            }
