...
@Serializable
class Meta2GUIBitStateCmd : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIBitStateCmd{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIBitStateCmd>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIBitStateCmd.fontSize != 0) this@Meta2GUIBitStateCmd.fontSize.px else DefaultTextSize.px
            }
