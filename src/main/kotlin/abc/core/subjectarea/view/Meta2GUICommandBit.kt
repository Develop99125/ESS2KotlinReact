...
@Serializable
class Meta2GUICommandBit : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUICommandBit{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUICommandBit>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.button {
            css {
                ...
                //fontSize = if (this@Meta2GUICommandBit.fontSize != 0) this@Meta2GUICommandBit.fontSize.px else DefaultTextSize.px
                fontSize = 12.px
            }
            +"${this@Meta2GUICommandBit.title}"
        }
    }
