...
@Serializable
class Meta2GUIFormSelector : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIFormSelector{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIFormSelector>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = this@Meta2GUIFormSelector.fontSize.px
            }
