...
@Serializable
class Meta2GUI3StateBoxSmall : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUI3StateBoxSmall{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUI3StateBoxSmall>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUI3StateBoxSmall.fontSize != 0) this@Meta2GUI3StateBoxSmall.fontSize.px else DefaultTextSize.px
            }
