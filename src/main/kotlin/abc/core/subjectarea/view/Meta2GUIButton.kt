...
@Serializable
class Meta2GUIButton : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIButton{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIButton>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIButton.fontSize != 0) this@Meta2GUIButton.fontSize.px else DefaultTextSize.px
            }
