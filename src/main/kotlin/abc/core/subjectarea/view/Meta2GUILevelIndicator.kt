...
@Serializable
class Meta2GUILevelIndicator : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUILevelIndicator{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUILevelIndicator>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUILevelIndicator.fontSize != 0) this@Meta2GUILevelIndicator.fontSize.px else DefaultTextSize.px
            }
            +"${minWarn.registerValue}"
        }
    }
