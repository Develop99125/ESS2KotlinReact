...
@Serializable
class Meta2GUIImageScriptLevel : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIImageScriptLevel{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIImageScriptLevel>(json)
    }
