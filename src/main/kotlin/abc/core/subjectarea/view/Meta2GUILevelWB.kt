...
@Serializable
class Meta2GUILevelWB : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUILevelWB{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUILevelWB>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUILevelWB.fontSize != 0) this@Meta2GUILevelWB.fontSize.px else DefaultTextSize.px
            }
