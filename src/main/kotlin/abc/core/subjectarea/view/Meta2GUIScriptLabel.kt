...
@Serializable
class Meta2GUIScriptLabel : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIScriptLabel{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIScriptLabel>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIScriptLabel.fontSize != 0) this@Meta2GUIScriptLabel.fontSize.px else DefaultTextSize.px
            }
