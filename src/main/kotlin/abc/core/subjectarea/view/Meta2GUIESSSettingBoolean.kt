...
@Serializable
class Meta2GUIESSSettingBoolean : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIESSSettingBoolean{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIESSSettingBoolean>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        val sz = 24
        val offset = (25 - sz) / 2
        val newX = x + dx + 5 + offset
        val newY = y + (h - 15) / 2 - 5 + offset
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIESSSettingBoolean.fontSize != 0) this@Meta2GUIESSSettingBoolean.fontSize.px else DefaultTextSize.px
            }
