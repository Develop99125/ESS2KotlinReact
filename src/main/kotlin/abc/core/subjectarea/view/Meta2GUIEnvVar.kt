...
@Serializable
class Meta2GUIEnvVar : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIEnvVar{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIEnvVar>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIEnvVar.fontSize != 0) this@Meta2GUIEnvVar.fontSize.px else DefaultTextSize.px
            }
