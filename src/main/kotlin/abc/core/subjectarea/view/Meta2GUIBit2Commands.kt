...
@Serializable
class Meta2GUIBit2Commands : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIBit2Commands{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIBit2Commands>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIBit2Commands.fontSize != 0) this@Meta2GUIBit2Commands.fontSize.px else DefaultTextSize.px
            }
