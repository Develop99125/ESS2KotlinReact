...
@Serializable
class Meta2GUIBitsList : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIBitsList{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIBitsList>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIBitsList.fontSize != 0) this@Meta2GUIBitsList.fontSize.px else DefaultTextSize.px
            }
