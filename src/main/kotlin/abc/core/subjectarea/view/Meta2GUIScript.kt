...
@Serializable
class Meta2GUIScript : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUIScript{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIScript>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUIScript.fontSize != 0) this@Meta2GUIScript.fontSize.px else DefaultTextSize.px
            }
