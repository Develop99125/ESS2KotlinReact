...
@Serializable
class Meta2GUI3StateBox : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUI3StateBox{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUI3StateBox>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUI3StateBox.fontSize != 0) this@Meta2GUI3StateBox.fontSize.px else DefaultTextSize.px
            }
