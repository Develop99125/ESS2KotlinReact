...
@Serializable
class Meta2GUITimeSetting : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUITimeSetting{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUITimeSetting>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUITimeSetting.fontSize != 0) this@Meta2GUITimeSetting.fontSize.px else DefaultTextSize.px
            }
