...
@Serializable
class Meta2GUIIndexLabel : RComponent<Props, State>() {
    var oid:Long=0
    var valid:Boolean=false
    var stackLevel:Int=0
    var type:Int=0
    var x:Int=0
    var y:Int=0
    var dx:Int=0
    ...
    override fun clone() : Meta2GUIIndexLabel{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUIIndexLabel>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = this@Meta2GUIIndexLabel.fontSize.px
            }
