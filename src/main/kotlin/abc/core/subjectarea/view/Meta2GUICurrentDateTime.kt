...
@Serializable
class Meta2GUICurrentDateTime : RComponent<Props, State>() {
    var oid:Long=0
    ...
    override fun clone() : Meta2GUICurrentDateTime{
        val json = Json.encodeToString(this)
        return Json.decodeFromString<Meta2GUICurrentDateTime>(json)
    }
    ...
    override fun ChildrenBuilder.render() {
        ...
        ReactHTML.p {
            css {
                ...
                fontSize = if (this@Meta2GUICurrentDateTime.fontSize != 0) this@Meta2GUICurrentDateTime.fontSize.px else DefaultTextSize.px
            }
